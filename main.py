...
def train(args, model):
    ...
    train_loader = DataLoader(dataset=train_set, shuffle=shuffle, batch_size=args.batchsize, num_workers=2)
    test_loader = DataLoader(dataset=test_set, shuffle=shuffle, batch_size=args.batchsize, num_workers=2)
